...
Next scanner-side plan: harden Plan 0060 Milestone 3 front/back pairing into an OCR/contextual pair graph that handles reversed order, dropped blank backs, same-stem image captures, and non-adjacent compatible backs without treating adjacency as sufficient evidence.
