...
Latest completed offline product-hardening plan: `docs/dev/plans/0031-2026-06-15-child-replacement-rollup-visibility.md`.
Next production plan: `docs/dev/plans/0009-2026-06-14-operator-selected-live-smoke-and-pilot-rollout.md`.
Next offline boundary: child replacement stale/readiness drill and operator sample output.
